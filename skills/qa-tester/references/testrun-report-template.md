...
> Build/env: <...> | Branch: feature/T-010-... | MR head: <commit> | Docs: spec v3, tasks v2 | Executed by: <agent/user>
...
- The `Docs:` line records the spec/tasks versions the run verified against. If those files bumped after the MR was opened, re-check the affected requirements before issuing `merge-approved`.
